...
public class TextFlowLayout extends ViewGroup {
    ...
    public TextFlowLayout(Context context,AttributeSet attrs,int defStyleAttr) {
        ...
        //去拿到相关属性
        TypedArray ta = context.obtainStyledAttributes(attrs,R.styleable.TextFlowStyle);
        mItemHorizontalSpace = ta.getDimension(R.styleable.TextFlowStyle_horizontalSpace,DEFAULT_SPACE);
        mItemVerticalSpace = ta.getDimension(R.styleable.TextFlowStyle_verticalSpace,DEFAULT_SPACE);
        ta.recycle();
    }
