...
public class ScrollingUtil {
    ...
    public static boolean isViewToBottom(View view, int mTouchSlop) {
        ...
        if (view instanceof TbNestedScrollView) return isNestedScrollViewToBottom((TbNestedScrollView) view, mTouchSlop);
        if (view instanceof ViewGroup) return isViewGroupToBottom((ViewGroup) view);
        return false;
    }

    private static boolean isNestedScrollViewToBottom(TbNestedScrollView view, int mTouchSlop) {
